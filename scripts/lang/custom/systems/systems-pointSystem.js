$.lang.register('pointsystem.add.all.success', 'Všichni v chatu právě dostali $1 (points)!');
$.lang.register('pointsystem.take.all.success', 'Všem v chatu bylo odebráno $1 (points) :-(');
$.lang.register('pointsystem.user.success', ' $1 má $2 (points).');
$.lang.register('pointsystem.add.success', 'Přidáno $1 pro $2. Aktuálně má $3 (points).');
$.lang.register('pointsystem.add.all.usage', 'Použito: !points all [amount]');
$.lang.register('pointsystem.take.all.usage', 'Použito: !points takeall [amount]');
$.lang.register('pointsystem.add.error.negative', 'Nemůžeš dát záporné množství (points) $1.');
$.lang.register('pointsystem.take.error.negative', 'Nemůžeš vzít záporné množství (points) $1.');
$.lang.register('pointsystem.add.usage', 'Použito: !points add [name] [amount]');

$.lang.register('pointsystem.makeitrain.error.invalid', 'Ooops. Teď není možné přivolat déšť.');
$.lang.register('pointsystem.makeitrain.error.needpoints', 'Nemáš dost (points) na déšť za $1.');
$.lang.register('pointsystem.makeitrain.error.negative', 'Nemůžeš použít záporné číslo.');
$.lang.register('pointsystem.makeitrain.success', 'Připravte si deštníky, budou pršet body! Díky $1 za $2 (points)!');
$.lang.register('pointsystem.makeitrain.usage', 'Použito: !makeitrain [amount]');
